...
namespace BookStore.Service.Implementation
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(EmailMessage allMails)
        {
            ...
            {
                Sender = new MailboxAddress("Book Store", "integrated_systems_finki@outlook.com"),
                Subject = allMails.Subject
            };

            emailMessage.From.Add(new MailboxAddress("Book Store", "integrated_systems_finki@outlook.com"));
