...
namespace BookStore.Repository.Migrations
{
    ...
    [Migration("20240626203842_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Domain.Domain.BooksInShoppingCart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStore.Domain.EmailMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStore.Domain.Domain.ShoppingCart", b =>
                {
                    b.HasOne("BookStore.Domain.Identity.BookStoreUsers", "Owner")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookStore.Domain.Identity.BookStoreUsers", null)
                        .WithMany()
